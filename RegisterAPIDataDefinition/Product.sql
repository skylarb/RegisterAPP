...
CREATE TABLE product (
  ...
  lookupcode character varying(32) DEFAULT(''), --Stored in the edu.uark.models.entities:ProductEntity#lookupCode property. See also the named constant defined in edu.uark.models.entities.fieldnames:ProductFieldNames that is used for Java <-> SQL mappings.
  ...
  active int not null,--active item here
  price numeric(10,2) not null,--price item here
